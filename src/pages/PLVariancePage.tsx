...
export function PLVariancePage() {
  ...
  return <section className='rounded-xl bg-white p-6 shadow-sm'>
    ...
    <div className='mt-4 grid gap-3 md:grid-cols-4 text-sm'>
      <div className='rounded-lg border bg-slate-50 p-3'><div className='text-slate-500'>Revenue Variance</div><div className='font-semibold'>{fmtAmount(card.rev, true)}</div></div>
      <div className='rounded-lg border bg-slate-50 p-3'><div className='text-slate-500'>Gross Profit Variance</div><div className='font-semibold'>{fmtAmount(card.gp, true)}</div></div>
      <div className='rounded-lg border bg-slate-50 p-3'><div className='text-slate-500'>Operating Profit Variance</div><div className='font-semibold'>{fmtAmount(card.op, true)}</div></div>
