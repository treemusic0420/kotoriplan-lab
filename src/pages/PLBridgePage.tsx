...
export function PLBridgePage() {
  ...
  return <section className='rounded-xl bg-white p-6 shadow-sm'>
    ...
    <LearningNotes title='PL Bridge' purpose='Explain operating profit movement by separating revenue impact, variable cost impact, and fixed cost impact.' keyQuestion='What explains the movement from base operating profit to compare operating profit?' whenToUse={['When management asks why operating profit changed.', 'When you need a concise story from budget to actual or forecast to actual.']} howToRead={['Start from base operating profit.', 'Add revenue impact.', 'Subtract variable cost impact and fixed cost impact.', 'End at compare operating profit.']} fpnaTips={['Bridge analysis is useful for executive communication.']} nextAction={['Use the bridge as an executive explanation of profit movement.', 'Translate major impacts into business actions.']} />
