...
export function PLRatioAnalysisPage() {
  ...
  return <section className='rounded-xl bg-white p-6 shadow-sm'>
    ...
    <LearningNotes title='Ratio Analysis' purpose='Review profitability and cost structure using margin and cost ratios.' keyQuestion='Is the business converting revenue into profit efficiently?' whenToUse={['When revenue size differs across months or segments.', 'When you want to evaluate efficiency rather than absolute amount.']} howToRead={['Check gross margin and contribution margin.', 'Then check variable cost ratio, SG&A ratio, and operating margin.', 'Look for ratio trends rather than one-time values.']} fpnaTips={['Ratios tell you how efficiently the business converts revenue into profit.']} nextAction={['Track margin trends over time.', 'Investigate months or segments where ratios deteriorate.']} />
