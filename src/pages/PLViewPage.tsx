...
export function PLViewPage(){
  ...
  <LearningNotes
    ...
    keyQuestion='What is the overall profit structure by month?'
    nextAction={['If profit changed significantly, move to PL Variance or PL Bridge.', 'If you need segment detail, move to PL by Dimension.']}
  />
